...
function ListItem(props: ListItemProps) {
  return (
    <div className="relative">
      <div className="absolute left-[-16px] top-[10px] w-[10px] h-[10px] bg-primary rounded-full"></div>
...
function HeaderItem(props: HeaderItemProps) {
  return <h2 className="h2 text-[32px] leading-[32px]">{props.value}</h2>;
}
        ...
        >
              ...
              <div>
                ...
                >
                  <Image
                    src={Acc}
                    alt="acc"
                    className="absolute left-[-40px] top-[-50px]"
                  />
                  PRIVACY
                  <br />
                </p>
                ...
                >
                  ...
                  <Image
                    src={Smilex}
                    alt="smile x"
                    className="absolute right-[-150px] bottom-[-50px] z-[-1] max-[700px]:w-[50%] max-[500px]:right-[-80px] max-[500px]:bottom-[0px] unzoom"
                  />
                </p>
              </div>
            </div>
          ...
          <div className="max-w-[898px] pr-[150px] pl-[63px] flex flex-col gap-[105px] pt-[176px] max-[1000px]:mr-[16px] max-[1000px]:ml-[16px] max-[1000px]:pl-[0] max-[1000px]:pt-[64px] relative z-[1] max-[1250px]:pr-[0px]">
            <Section>
              <div>
                <h5 className="h5 text-[24px] leading-[28px]">
                  ...
                  about how we handle it. This Privacy Policy explains how we
                  collect, use, and safeguard your data when you visit our
                  website, join our waitlist, or use our services.
                </h5>
              </div>
              <div>
                <h5 className="h5 text-[24px] leading-[28px]">
            ...
            <Section>
              ...
              <div>
                <h5 className="h5 text-[24px] leading-[28px]">
                  We only collect the information necessary to provide updates
            ...
            <Section>
              ...
              <div>
                <h5 className="h5 relative text-[24px] leading-[28px]">
                  Under the DPDP Act, 2023, you have the right to:{" "}
                  <Image
                    src={Thumbm}
                    alt="smile x"
                    className="absolute right-[0px] bottom-[40px] z-[-1]"
                  />
                </h5>
              </div>
              <div className="pl-[50px] flex flex-col gap-[20px]">
            ...
            <Section>
              ...
              <div>
                <h5 className="h5 text-[24px] leading-[28px]">
                  ...
                  We do not knowingly collect information from minors. If such
            ...
            <Section>
              ...
              <div>
                <h5 className="h5 text-[24px] leading-[28px]">
                  ...
                  significant, we will notify you through email or a notice on
                  our website.
                </h5>
              </div>
            </Section>
            <Section>
              ...
              <div>
                <h5 className="h5 text-[24px] leading-7">
